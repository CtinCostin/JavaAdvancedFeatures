package com.sda.georgescuconstantin.input.output;
...
//        writeDataToFile();
 //       readWriteFileSampleVersion();
    ...
    public static void sample() {
        try {
            // Count words.
            List<String> contentList = Files.readAllLines(Paths.get("mydate.txt"));
...
//            System.out.println(stringBuilder.toString());
    ...
    public static void readWriteFileSampleVersion() {
        try {
            ...
            List<String> fileLines = Files.readAllLines(Paths.get("mydate.txt"));
            ...
            Files.write(Paths.get("mydate.txt"), dataContent);
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    }
...
//            afisare data
    ...
    public static void readDataFromFile() {
        ...
        try (BufferedReader bufferedReader = new BufferedReader(new FileReader("mydate.txt"))) {
