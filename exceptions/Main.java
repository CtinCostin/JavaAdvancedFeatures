...
//        double diffBetweenTwoNumbers(int a, int b) throws Exception {}
        ...
        try {
            ...
            double result = diffBetweenTwoNumbers(10, 9);
...
//            e.printStackTrace();
    ...
    //a=4,b=0;
    public static double diffBetweenTwoNumbers(int a, int b) throws ArithmeticException {
        if (a == 0 || b == 0) {
            // daca a sau b sunt 0 aruncam o exceptie cu mesaul "Numerele sunt invalide"
            throw new ArithmeticException("Numerele sunt invalide");
        } else {
