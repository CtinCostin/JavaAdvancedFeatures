package com.sda.georgescuconstantin.lambda.exercises;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("With lambda: " + additionLambda.calculate(2, 3));

        Math subtractionLambda = (a, b) -> a - b;
        System.out.println("substraction: " + subtractionLambda.calculate(2, 3));
